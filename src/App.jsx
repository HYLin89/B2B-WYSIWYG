...
import AccVerify from './pages/accVerfi';
import RetrievePsw from './pages/retrievePsw';
import PswReset from './pages/psw_reset'; 
...
const PasswordWait=()=>{return <h2>請確認您的信箱...</h2>}
const ErrorPage = () => {
	return (
		<>
			<Header /> 
			<main style={{ padding: '0.5rem 2rem 2rem 2rem' }}>
...
const router = createBrowserRouter([
	{
		...
		children: [
			...
			{ path: "/verify", element: <AccVerify /> },
			{ path: "/forgot_password", element: <RetrievePsw /> },
			{ path: "/passwordwait", element: <PasswordWait /> },
			{ path: "/psw_reset", element: <PswReset /> },
			{ path: "/search", element: <Search /> },
			{ path: "/editor/:id?", element: <EditorPage /> },
			{ path: "/article/:id", element: <Article /> },
			{ path: "/profile", element: <Profile /> },
			{ path: "/:account", element: <Portfolio />},
